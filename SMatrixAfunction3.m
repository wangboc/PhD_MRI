function OutImg=SMatrixAfunction3(InputImg,WeightingFunctions,Sampledtrajectory,I,D)
...
for k=1:nc
    ...
    kspaceData(:,:,k)=SEE(Sampledtrajectory,imageweighted(:,:,k));
 
    xspaceimage(:,:,k)=SEH(Sampledtrajectory,kspaceData(:,:,k),D);
